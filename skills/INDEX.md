...
| `mes-server/SKILL.md` | 1.3KB | MES Server(NestJS)代码知识库：架构/API/迁移/业务逻辑 |
...
mes-server        → _core/mes-domain-knowledge + _core/n8n-process-map + references/*
```
...
| 2026-04-15 | 增强：新增mes-server代码知识库，更新mes-domain-knowledge/n8n-process-map/problem-router，共22个文件~86KB | OpenClaw Agent |
